...
Partial Public Class MyDBDataSet
    ...
    Partial Public Class studentDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddstudentRow(ByVal StudentName As String, ByVal Course As String, ByVal Gender As String, ByVal DOB As Date, ByVal Category As String, ByVal Add As String, ByVal Email As String, ByVal Contact As Integer, ByVal State As String, ByVal City As String) As studentRow
            Dim rowstudentRow As studentRow = CType(Me.NewRow,studentRow)
            Dim columnValuesArray() As Object = New Object() {StudentName, Course, Gender, DOB, Category, Add, Email, Contact, State, City}
...
Namespace MyDBDataSetTableAdapters
    ...
    Partial Public Class studentTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `student` (`StudentName`, `Course`, `Gender`, `DOB`, `Category`, `Add"& _ 
                "`, `Email`, `Contact`, `State`, `City`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.DBConnection.My.MySettings.Default.MyDBConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT StudentName, Course, Gender, DOB, Category, [Add], Email, Contact, State, "& _ 
                "City FROM student"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As MyDBDataSet.studentDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As MyDBDataSet.studentDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As MyDBDataSet.studentDataTable = New MyDBDataSet.studentDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As MyDBDataSet.studentDataTable) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal StudentName As String, ByVal Course As String, ByVal Gender As String, ByVal DOB As Global.System.Nullable(Of Date), ByVal Category As String, ByVal Add As String, ByVal Email As String, ByVal Contact As Global.System.Nullable(Of Integer), ByVal State As String, ByVal City As String) As Integer
